...
/**
 * Adjusted Firmware for the Biqu MicroProbe V2
 * Adjustments made by Dauwt
 */
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0 // Change for your Motherboard
#endif
...
#define Z_MIN_ENDSTOP_HIT_STATE LOW       // If you have a Biqu MicroProbe V1 leave this HIGH
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE LOW  // If you have a Biqu MicroProbe V1 leave this HIGH
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN     // You'll have to connect the Probe and GND Pin to the Z_Endstop Pins in your Motherboard
 ...
 */
//#define BIQU_MICROPROBE_V1  // Triggers HIGH  Uncomment this one and comment the other one bellow it if you have a Biqu MicroProbe V1
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.0, -8.20, -1.50 }    // Try and measure precisely this values yourself, it may change!        **USE THE 'Z PROBE WIZARD' TO MEASURE THE Z OFFSET**
...
#define XY_PROBE_FEEDRATE (133*2*60)
